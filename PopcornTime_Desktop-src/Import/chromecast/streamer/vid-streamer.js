...
var vidStreamer = function (req, res) {
    ...
    vidStreamer.sendInfo('vidStreamer: Request to file ' + req.url);
    ...
    vidStreamer.sendInfo('vidStreamer: Local path file ' + info.path);
...
handler.on("badFile", function (res, e) {
    ...
    res.end("<!DOCTYPE html><html lang=\"en\">" +
        ...
        "</body></html>");
    vidStreamer.sendError("404 Bad File - " + (e ? e.message : ""));
});
...
handler.on("badRange", function (res, e) {
    ...
    res.end("<!DOCTYPE html><html lang=\"en\">" +
        ...
        "</body></html>");
    vidStreamer.sendError("416 Bad Range - " + (e ? e.message : ""));
});
...
handler.on("security", function (res, e) {
    ...
    res.end("<!DOCTYPE html><html lang=\"en\">" +
        ...
        "</body></html>");
    vidStreamer.sendError("403 Security - " + (e ? e.message : ""));
});
...
handler.on("badMime", function (res, e) {
    ...
    res.end("<!DOCTYPE html><html lang=\"en\">" +
        ...
        "</body></html>");
    vidStreamer.sendError("403 Bad MIME - " + (e ? e.message : ""));
});
...
handler.on("badRequest", function (res, e) {
    ...
    res.end("<!DOCTYPE html><html lang=\"en\">" +
        ...
        "</body></html>");
    vidStreamer.sendError("400 Bad Request - " + (e ? e.message : ""));
});
...
handler.on("noRandomFiles", function (res, e) {
    ...
    res.end("<!DOCTYPE html><html lang=\"en\">" +
        ...
        "</body></html>");
    vidStreamer.sendError("404 No Random Files - " + (e ? e.message : ""));
});
