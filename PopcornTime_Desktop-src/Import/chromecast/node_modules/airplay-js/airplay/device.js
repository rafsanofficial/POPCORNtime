...
function Device ( id, info, name, callback ) {
    ...
    this.client.on( 'error', function (error) { self.onError(error); });
}

util.inherits( Device, events.EventEmitter );
exports.Device = Device;
Device.prototype.onError = function ( error ) {
    if (this.listeners && this.listeners('error') && this.listeners('error').length > 0)
        this.emit( 'error' );
}
