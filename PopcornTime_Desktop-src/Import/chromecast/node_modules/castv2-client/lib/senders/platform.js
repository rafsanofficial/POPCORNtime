...
PlatformSender.prototype.play = function(callback) {
    this.receiver.play( callback);
};
PlatformSender.prototype.pause = function(callback) {
    this.receiver.pause( callback);
};
...
PlatformSender.prototype.setVolumeMute = function(volume, muted, callback) {
    this.receiver.setVolumeMute(volume,muted, callback);
};
PlatformSender.prototype.getVolume = function(callback) {
  this.receiver.getVolume(callback);
};

PlatformSender.prototype.setMute = function(muted, callback) {
    this.receiver.setMute(muted, callback);
};

PlatformSender.prototype.getMute = function(callback) {
    this.receiver.getMute(callback);
};
